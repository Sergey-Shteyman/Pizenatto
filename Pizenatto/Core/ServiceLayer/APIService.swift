...
extension APIService: APIServicable {
    ...
    func fetchPromotions(completion: @escaping (Result<[PromotionModel], Error>) -> Void) {
        let urlString = "https://gist.githubusercontent.com/Sergey-Shteyman/2a7aa78ababc886c7a2c7f0a0da6b3ee/raw/c325b779f792ae5510e7a5fe17c4d0db3319ff1d/promotion.json"
